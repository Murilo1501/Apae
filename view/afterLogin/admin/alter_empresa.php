                ...
                <form method="post" action= <?= '/newApae/admin/update/'.$userData['id'] ?>>
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <div class="col-md-12 mb-3"> <input type="text" class="form-control" id="nome" 
                            placeholder="Nome" maxlenght="64" minlenght="2" autocomplete='off' value='<?=$userData['nome']?>' readonly style='background-color: #e9ecef;' required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <div class="col-md-12 mb-3"> <input type="text" class="form-control" id="ramo_atividade" name="ramoAtiv"
                                placeholder="Ramo de atividade" maxlenght="64" minlenght="2" autocomplete='off' value='<?=$userData['ramoAtiv']?>'
                                required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <div class="col-md-12 mb-3"> <input type="text" class="form-control" name="email" id="email"
                                ...
                                readonly value='<?=$userData['email']?>' style='background-color: #e9ecef;' required>
                        </div>
                    </div>
                    ...
                    <div class="mt-3 mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control" id="password" placeholder="Senha" maxlength="24"
                                minlength="8" pattern="(?=.*\d)(?=.*[A-Z])(?=.*[a-z]).{8,24}" aria-label="button-addon1" name="Senha">
